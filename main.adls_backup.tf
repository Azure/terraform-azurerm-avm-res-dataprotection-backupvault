# ADLS (Azure Data Lake Storage Gen2) Backup Policies
resource "azapi_resource" "backup_policy_adls_storage" {
  for_each = local.adls_policies
  ...
  body = {
    properties = {
      ...
      datasourceTypes = ["Microsoft.Storage/storageAccounts/adlsBlobServices"]
    }
  }
