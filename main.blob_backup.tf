...
resource "azurerm_data_protection_backup_policy_blob_storage" "this" {
  ...
  backup_repeating_time_intervals        = length(each.value.backup_repeating_time_intervals) > 0 ? each.value.backup_repeating_time_intervals : ["R/2025-01-01T02:00:00+00:00/P1D"]
